...
const Mug3DViewer = dynamic(
  ...
  {
    ssr: false,
    loading: () => <div className="w-full h-[700px] bg-graphite animate-pulse rounded-lg flex items-center justify-center font-mono text-pearl">Loading 3D Engine...</div>,
  },
);
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          ...
          {uploadedImage && (
            <div className="bg-graphite border border-smoke/30 p-6 rounded-lg">
              ...
              {error && (
                <p className="text-[#FF4D4D] font-mono text-[11px] mt-2 bg-red-950/30 px-3 py-2 rounded-sm border border-red-900/40">
                  {error}
                </p>
              )}
            </div>
          ...
          {/* Text Tool */}
          <div className="bg-graphite border border-smoke/30 p-6 rounded-lg flex flex-col gap-5">
            <h3 className="font-mono text-caption text-bone uppercase tracking-widest">Add Text</h3>
            ...
            <input
              ...
              className="w-full bg-charcoal border border-smoke text-bone p-3 font-mono text-sm placeholder:text-ash focus:outline-none focus:border-cobalt transition-colors"
            />
              ...
              <div className="flex gap-4">
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <select
                    ...
                    className="w-full bg-charcoal border border-smoke text-bone p-2 font-mono text-xs focus:outline-none focus:border-cobalt"
                  >
