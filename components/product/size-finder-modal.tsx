              ...
              <div className="border border-smoke/40 rounded-sm p-4 flex items-center justify-between gap-4">
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <span className="font-mono text-[9px] text-pearl">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-smoke/40">
                    <th className="py-2 pr-4 font-mono text-[10px] text-ash uppercase tracking-widest font-normal">
                      Size
                    </th>
                    <th className="py-2 px-2 font-mono text-[10px] text-ash uppercase tracking-widest font-normal">
                      Chest (in)
                    </th>
                    <th className="py-2 px-2 font-mono text-[10px] text-ash uppercase tracking-widest font-normal">
                      Chest (cm)
                    </th>
                    <th className="py-2 pl-2 font-mono text-[10px] text-ash uppercase tracking-widest font-normal">
                      Length (in)
                    </th>
                  </tr>
                </thead>
                <tbody className="text-bone font-mono text-xs">
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">XS</td>
                    <td className="py-3 px-2">36"</td>
                    <td className="py-3 px-2">91</td>
                    <td className="py-3 pl-2">26"</td>
                  </tr>
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">S</td>
                    <td className="py-3 px-2">38"</td>
                    <td className="py-3 px-2">96</td>
                    <td className="py-3 pl-2">27"</td>
                  </tr>
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">M</td>
                    <td className="py-3 px-2">40"</td>
                    <td className="py-3 px-2">101</td>
                    <td className="py-3 pl-2">28"</td>
                  </tr>
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">L</td>
                    <td className="py-3 px-2">42"</td>
                    <td className="py-3 px-2">106</td>
                    <td className="py-3 pl-2">29"</td>
                  </tr>
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">XL</td>
                    <td className="py-3 px-2">44"</td>
                    <td className="py-3 px-2">112</td>
                    <td className="py-3 pl-2">30"</td>
                  </tr>
                  <tr className="border-b border-smoke/20">
                    <td className="py-3 pr-4 text-cobalt font-bold">XXL</td>
                    <td className="py-3 px-2">46"</td>
                    <td className="py-3 px-2">117</td>
                    <td className="py-3 pl-2">31"</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="font-mono text-[9px] text-ash leading-relaxed mt-2 p-3 bg-smoke/10 rounded-sm">
              * Measurements may have a tolerance of +/- 0.5 to 1 inch (1.25–2.5 cm). Hoodies are
              typically styled slightly larger to accommodate layering.
            </p>
          </div>
        )}
      </div>
