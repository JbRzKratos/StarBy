    ...
    <div ref={containerRef}>
      ...
      <div className="mt-8 flex flex-col gap-4">
        ...
        <button
          ...
          className="w-full border border-smoke bg-graphite text-pearl font-mono text-caption uppercase tracking-widest py-4 hover:border-cobalt hover:text-cobalt transition-colors rounded-lg flex items-center justify-center gap-2"
        >
          <svg
            width="16"
            height="16"
